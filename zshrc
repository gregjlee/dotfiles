...
export ZSH="/Users/greglee/.oh-my-zsh"
...
alias hotel_stop="sudo launchctl unload /Library/LaunchDaemons/hotel.plist"
alias hotel_start="sudo launchctl load /Library/LaunchDaemons/hotel.plist"
